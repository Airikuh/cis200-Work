...
int main() {
	...
	cout << "The Calculation of The Function fib2(): the Fibonacci Sequence Without Redundant Calls = " << fib2(n) << endl;
...
//Function That Calculates Fibonacci Sequence Without Redundant Function Calls
int fib2(int x) {
	//Variable Declarations
